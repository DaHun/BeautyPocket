...
public class GogagCenter extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_gogag_center);
    }

    public void top_click15(View v) {
        switch (v.getId()) {
            case R.id.btn_up_home15:
