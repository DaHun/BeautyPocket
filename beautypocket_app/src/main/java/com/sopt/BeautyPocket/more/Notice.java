...
public class Notice extends AppCompatActivity {
    ...
    public void top_click16(View v) {
        switch (v.getId()) {
            case R.id.btn_up_home16:
